...
export GAZEBO_MODEL_PATH="/home/a/PX4-Autopilot/Tools/simulation/gazebo-classic/sitl_gazebo-classic/models:$GAZEBO_MODEL_PATH"
export DISPLAY=:0
...
roslaunch /home/a/PX4-Autopilot/launch/mavros_posix_sitl_perching_16cm.launch &
SIM_PID=$!
...
PYTHONUNBUFFERED=1 stdbuf -oL python3 /home/a/huaqiccc_test_suite/perching/grasp_16cm.py 2>&1 | tee /tmp/grasp_test.log
