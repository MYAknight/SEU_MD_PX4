...
# Run flight test
echo "[FLIGHT] Starting perching pole collision test..."
PYTHONUNBUFFERED=1 stdbuf -oL python3 /home/a/huaqiccc_test_suite/perching/pole_collision.py 2>&1 | tee /tmp/perching_test.log
